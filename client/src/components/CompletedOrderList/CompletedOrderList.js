...
import styles from "./CompletedOrderList.module.scss";
...
const mapStateToProps = (state) => ({
  item: state.payment.completed_orders,
});
export default connect(mapStateToProps, { getCompletedOrders })(
  CompletedOrderList
);
