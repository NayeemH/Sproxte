...
const LandingNavbar = () => {
  return (
    <div className={`py-3 ${styles.wrapper}`}>
      ...
      <div className="d-flex align-items-center flex-md-row flex-column mt-md-0 mt-2">
        <div
          className={`shadow-sm ${styles.box} d-flex flex-column flex-md-row align-items-center my-md-0 my-2  d-md-block d-none`}
        >
